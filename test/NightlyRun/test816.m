%Test Name: SSA2dCDCalvingButtressingLakeDepth
...
md.calving.surface_hydrology_type=2;
...
md.transient.requested_outputs={'default', 'CrevasseDepth', 'BasalCrevasse', 'SurfaceCrevasse','LakeDepth'};
md=solve(md,'Transient');

%Fields and tolerances to track changes
field_names ={...
    'Vx1','Vy1','Vel1','Pressure1','Thickness1','Surface1','MaskIceLevelset1',...
    'CrevasseDepth1', 'BasalCrevasse1', 'SurfaceCrevasse1','LakeDepth1', ...
    'Vx2','Vy2','Vel2','Pressure2','Thickness2','Surface2','MaskIceLevelset2',...
    'CrevasseDepth2', 'BasalCrevasse2', 'SurfaceCrevasse2','LakeDepth2', ...
    'Vx10','Vy10','Vel10','Pressure10','Thickness10','Surface10','MaskIceLevelset10',...
    'CrevasseDepth10', 'BasalCrevasse10', 'SurfaceCrevasse10','LakeDepth10',...
    'Vx20','Vy20','Vel20','Pressure20','Thickness20','Surface20','MaskIceLevelset20',...
    'CrevasseDepth20', 'BasalCrevasse20', 'SurfaceCrevasse20','LakeDepth20'};
field_tolerances={...
...
field_values={...
    ...
    md.results.TransientSolution(1).LakeDepth,...
    ...
    md.results.TransientSolution(2).LakeDepth,...
    ...
    md.results.TransientSolution(10).LakeDepth,...
    ...
    md.results.TransientSolution(20).LakeDepth,...
    };

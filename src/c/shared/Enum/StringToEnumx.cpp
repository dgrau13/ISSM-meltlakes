...
int  StringToEnumx(const char* name,bool notfounderror){
   ...
   if(stage==3){
	      if (strcmp(name,"FrontalForcingsSdmaOrder")==0) return FrontalForcingsSdmaOrderEnum;
   ...
   if(stage==5){
	      if (strcmp(name,"SolidearthSettingsElastic")==0) return SolidearthSettingsElasticEnum;
   ...
   if(stage==10){
	      if (strcmp(name,"SealevelchangeOldOceanLevelset")==0) return SealevelchangeOldOceanLevelsetEnum;
